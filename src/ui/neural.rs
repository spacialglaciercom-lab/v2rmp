...
pub fn draw(f: &mut Frame, app: &App, area: ratatui::layout::Rect) {
    let inner = super::draw_panel(f, "Neural ONNX Solver", area);
    ...
    let model_display = ratatui::text::Span::styled(
        app.vrp_model_path.clone(),
    ...
    let lines = vec![
        ratatui::text::Line::from(ratatui::text::Span::styled(
            "Neural Workflow — Direct ONNX Inference",
        ...
        ratatui::text::Line::from(vec![
            ratatui::text::Span::raw("Model Path (.onnx): "),
            model_display,
        ]),
        ratatui::text::Line::from(vec![
            ratatui::text::Span::raw("Waypoints (.json):  "),
            waypoints_display,
        ]),
        ratatui::text::Line::from(vec![
        ...
        ratatui::text::Line::from("  [M]  Set model path (.onnx)"),
        ratatui::text::Line::from("  [W]  Set waypoints file (.json)"),
        ...
        ratatui::text::Line::from("  [Enter] Run Neural Solver"),
